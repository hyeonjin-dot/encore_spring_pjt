                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="title" name="title" class="form-control" maxlength="50"
                                           placeholder="제목을 입력해 주세요." value="${boardResponse.title}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="writer" name="writer" class="form-control" maxlength="10"
                                           placeholder="이름을 입력해 주세요." value="${boardResponse.writer}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="content" name="content" class="form-control" maxlength="1000"
                                              placeholder="내용을 입력해 주세요.">${boardResponse.content}</textarea>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function () {
        $("#btn").click(function () {
            ...
            if (location.search == "") {
                console.log("location search is null path : board/write.hanwha");
                $("fmt").attr("action", "board/write.hanwha").submit();
            }else{
                console.log("location search is not null path : board/update.hanwha");
                $("#idx").val(${response.idx});
                $("#fmt").attr("action", "/board/update.hanwha").submit();
            }
        })
    });
